...
architecture behav of my_NN is 
    ...
    "my_NN,hls_ip_2018_1,{HLS_INPUT_TYPE=sc,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z100ffg1156-1,HLS_INPUT_CLOCK=200.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=29.931000,HLS_SYN_LAT=3,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=48,HLS_SYN_FF=75,HLS_SYN_LUT=4025}";
