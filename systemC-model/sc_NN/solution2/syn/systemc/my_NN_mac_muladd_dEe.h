...
#ifndef __my_NN_mac_muladd_dEe__HH__
#define __my_NN_mac_muladd_dEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(my_NN_mac_muladd_dEe) {
    ...
    SC_CTOR(my_NN_mac_muladd_dEe):  simcore_mac_0_U ("simcore_mac_0_U") {
