...
#ifndef __my_NN_mul_mul_18sg8j__HH__
#define __my_NN_mul_mul_18sg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(my_NN_mul_mul_18sg8j) {
    ...
    SC_CTOR(my_NN_mul_mul_18sg8j):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
