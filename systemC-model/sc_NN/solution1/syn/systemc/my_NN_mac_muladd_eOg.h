...
#ifndef __my_NN_mac_muladd_eOg__HH__
#define __my_NN_mac_muladd_eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(my_NN_mac_muladd_eOg) {
    ...
    SC_CTOR(my_NN_mac_muladd_eOg):  simcore_mac_1_U ("simcore_mac_1_U") {
