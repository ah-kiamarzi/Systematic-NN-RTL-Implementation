...
#ifndef __my_NN_mul_mul_18scud__HH__
#define __my_NN_mul_mul_18scud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(my_NN_mul_mul_18scud) {
    ...
    SC_CTOR(my_NN_mul_mul_18scud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
