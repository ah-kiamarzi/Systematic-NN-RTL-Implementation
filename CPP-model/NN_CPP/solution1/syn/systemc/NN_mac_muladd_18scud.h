...
#ifndef __NN_mac_muladd_18scud__HH__
#define __NN_mac_muladd_18scud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18scud) {
    ...
    SC_CTOR(NN_mac_muladd_18scud):  simcore_mac_0_U ("simcore_mac_0_U") {
