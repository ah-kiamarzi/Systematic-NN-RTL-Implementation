...
#ifndef __NN_mul_mul_18s_15ncg__HH__
#define __NN_mul_mul_18s_15ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mul_mul_18s_15ncg) {
    ...
    SC_CTOR(NN_mul_mul_18s_15ncg):  ACMP_smul_su_U ("ACMP_smul_su_U") {
