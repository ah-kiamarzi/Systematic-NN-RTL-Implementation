...
#ifndef __NN_mul_mul_18s_16eOg__HH__
#define __NN_mul_mul_18s_16eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mul_mul_18s_16eOg) {
    ...
    SC_CTOR(NN_mul_mul_18s_16eOg):  ACMP_smul_su_U ("ACMP_smul_su_U") {
