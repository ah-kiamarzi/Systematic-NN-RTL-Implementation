...
#ifndef __NN_mac_muladd_18skbM__HH__
#define __NN_mac_muladd_18skbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18skbM) {
    ...
    SC_CTOR(NN_mac_muladd_18skbM):  simcore_mac_5_U ("simcore_mac_5_U") {
