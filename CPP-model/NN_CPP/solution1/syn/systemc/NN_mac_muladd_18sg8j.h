...
#ifndef __NN_mac_muladd_18sg8j__HH__
#define __NN_mac_muladd_18sg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18sg8j) {
    ...
    SC_CTOR(NN_mac_muladd_18sg8j):  simcore_mac_3_U ("simcore_mac_3_U") {
