...
#ifndef __NN_mac_muladd_15nibs__HH__
#define __NN_mac_muladd_15nibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_15nibs) {
    ...
    SC_CTOR(NN_mac_muladd_15nibs):  simcore_mac_4_U ("simcore_mac_4_U") {
