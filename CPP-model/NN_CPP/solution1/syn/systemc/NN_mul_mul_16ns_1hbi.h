...
#ifndef __NN_mul_mul_16ns_1hbi__HH__
#define __NN_mul_mul_16ns_1hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mul_mul_16ns_1hbi) {
    ...
    SC_CTOR(NN_mul_mul_16ns_1hbi):  ACMP_smul_us_U ("ACMP_smul_us_U") {
