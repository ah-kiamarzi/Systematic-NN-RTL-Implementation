...
#ifndef __NN_mac_muladd_18sqcK__HH__
#define __NN_mac_muladd_18sqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18sqcK) {
    ...
    SC_CTOR(NN_mac_muladd_18sqcK):  simcore_mac_8_U ("simcore_mac_8_U") {
