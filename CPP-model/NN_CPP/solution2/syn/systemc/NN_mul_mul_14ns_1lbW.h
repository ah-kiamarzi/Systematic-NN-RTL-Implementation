...
#ifndef __NN_mul_mul_14ns_1lbW__HH__
#define __NN_mul_mul_14ns_1lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mul_mul_14ns_1lbW) {
    ...
    SC_CTOR(NN_mul_mul_14ns_1lbW):  ACMP_smul_us_U ("ACMP_smul_us_U") {
