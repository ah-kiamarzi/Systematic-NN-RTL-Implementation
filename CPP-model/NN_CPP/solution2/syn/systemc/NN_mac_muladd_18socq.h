...
#ifndef __NN_mac_muladd_18socq__HH__
#define __NN_mac_muladd_18socq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18socq) {
    ...
    SC_CTOR(NN_mac_muladd_18socq):  simcore_mac_6_U ("simcore_mac_6_U") {
