...
#ifndef __NN_mac_muladd_18sbkb__HH__
#define __NN_mac_muladd_18sbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18sbkb) {
    ...
    SC_CTOR(NN_mac_muladd_18sbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
