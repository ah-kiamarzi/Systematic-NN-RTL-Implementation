...
#ifndef __NN_mul_mul_15ns_1mb6__HH__
#define __NN_mul_mul_15ns_1mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mul_mul_15ns_1mb6) {
    ...
    SC_CTOR(NN_mul_mul_15ns_1mb6):  ACMP_smul_us_U ("ACMP_smul_us_U") {
