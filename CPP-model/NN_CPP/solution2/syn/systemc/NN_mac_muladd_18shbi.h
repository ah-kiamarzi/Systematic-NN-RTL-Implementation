...
#ifndef __NN_mac_muladd_18shbi__HH__
#define __NN_mac_muladd_18shbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18shbi) {
    ...
    SC_CTOR(NN_mac_muladd_18shbi):  simcore_mac_3_U ("simcore_mac_3_U") {
