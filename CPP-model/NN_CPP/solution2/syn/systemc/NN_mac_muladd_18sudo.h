...
#ifndef __NN_mac_muladd_18sudo__HH__
#define __NN_mac_muladd_18sudo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18sudo) {
    ...
    SC_CTOR(NN_mac_muladd_18sudo):  simcore_mac_11_U ("simcore_mac_11_U") {
