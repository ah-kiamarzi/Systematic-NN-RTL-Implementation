...
#ifndef __NN_mac_muladd_18stde__HH__
#define __NN_mac_muladd_18stde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18stde) {
    ...
    SC_CTOR(NN_mac_muladd_18stde):  simcore_mac_10_U ("simcore_mac_10_U") {
