...
#ifndef __NN_mac_muladd_18sdEe__HH__
#define __NN_mac_muladd_18sdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18sdEe) {
    ...
    SC_CTOR(NN_mac_muladd_18sdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
