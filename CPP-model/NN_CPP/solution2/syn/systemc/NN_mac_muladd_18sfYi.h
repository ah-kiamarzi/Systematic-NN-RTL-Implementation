...
#ifndef __NN_mac_muladd_18sfYi__HH__
#define __NN_mac_muladd_18sfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18sfYi) {
    ...
    SC_CTOR(NN_mac_muladd_18sfYi):  simcore_mac_2_U ("simcore_mac_2_U") {
