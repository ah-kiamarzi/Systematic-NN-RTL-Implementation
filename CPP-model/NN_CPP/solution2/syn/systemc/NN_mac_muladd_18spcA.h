...
#ifndef __NN_mac_muladd_18spcA__HH__
#define __NN_mac_muladd_18spcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_18spcA) {
    ...
    SC_CTOR(NN_mac_muladd_18spcA):  simcore_mac_7_U ("simcore_mac_7_U") {
