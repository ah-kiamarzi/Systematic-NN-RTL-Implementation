...
#ifndef __NN_mul_mul_16ns_1kbM__HH__
#define __NN_mul_mul_16ns_1kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mul_mul_16ns_1kbM) {
    ...
    SC_CTOR(NN_mul_mul_16ns_1kbM):  ACMP_smul_us_U ("ACMP_smul_us_U") {
