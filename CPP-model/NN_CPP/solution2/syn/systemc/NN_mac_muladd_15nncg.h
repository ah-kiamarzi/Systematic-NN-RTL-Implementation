...
#ifndef __NN_mac_muladd_15nncg__HH__
#define __NN_mac_muladd_15nncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NN_mac_muladd_15nncg) {
    ...
    SC_CTOR(NN_mac_muladd_15nncg):  simcore_mac_5_U ("simcore_mac_5_U") {
